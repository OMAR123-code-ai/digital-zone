    ...
    <footer className="bg-dbs-dark border-t border-dbs-border mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <Logo size="md" />
            <p className="mt-3 text-xs text-dbs-gold tracking-wide">
              L'innovation au service de votre quotidien
            </p>
            <p className="mt-3 text-sm text-dbs-silver leading-relaxed">
            ...
            <div className="flex gap-3 mt-4">
              {[Instagram, Facebook, Twitter, Youtube].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-9 h-9 rounded-full bg-dbs-card border border-dbs-border flex items-center justify-center text-dbs-silver hover:text-dbs-gold hover:border-dbs-gold transition"
                >
                  <Icon size={16} />
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-dbs-silver">
              ...
              <li><Link to="/faq" className="hover:text-dbs-gold transition">FAQ</Link></li>
              <li>
                <a href="https://wa.me/22673190710" target="_blank" rel="noopener noreferrer" className="hover:text-dbs-gold transition">
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-wrap gap-2">
                {['Orange Money', 'Moov', 'Wave', 'VISA'].map((m) => (
                  <span key={m} className="px-2 py-1 bg-dbs-card border border-dbs-border rounded text-[10px] text-dbs-silver">
                    {m}
                  </span>
                ))}
              </div>
